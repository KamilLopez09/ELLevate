  ...
  2: {
    ...
    brackets: {
      "5-9": {
        ...
        title: "Action Verbs - Kids Vocabulary",
        mode: "click-paint",
        prompts: [
          {
            id: "w2_810_r1",
            category: "review",
            mode: "click-paint",
            text: "I ___ a camper at ELLevate.",
            target: "am",
            options: ["am", "is", "are"],
          },
          {
          ...
          },
          {
            ...
            category: "core",
            mode: "click-paint",
            text: "The boy ___ across the room.",
            target: "runs",
            options: ["run", "runs", "sleeps"],
          },
          {
            id: "w2_810_c2",
            category: "core",
            mode: "click-paint",
            text: "The girl ___ up high.",
            target: "jumps",
            options: ["jump", "jumps", "eats"],
          },
          {
            id: "w2_810_c3",
            category: "core",
            mode: "click-paint",
            text: "The fish ___ in the water.",
            target: "swims",
            options: ["swims", "flies", "runs"],
          },
          {
            id: "w2_810_c4",
            category: "core",
            mode: "click-paint",
            text: "The bird ___ in the sky.",
            target: "flies",
            options: ["swims", "flies", "jumps"],
          },
          {
            id: "w2_810_g1",
            category: "generative",
            mode: "click-paint",
            text: "He is fast. He ___ every day.",
            target: "runs",
          ...
          },
          {
            ...
            category: "generative",
            mode: "click-paint",
            text: "They are birds. They do not swim, they ___.",
            target: "fly",
          ...
          },
          {
            ...
            category: "generative",
            mode: "click-paint",
            text: "First I run, and then I ___.",
            target: "jump",
            options: ["jumps", "jump", "jumping"],
          },
        ],
      },
      "10-14": {
